...
typedef enum {
    STATE_HOME = 0,
    STATE_VIS_REFLECTION_DISPLAY,
    STATE_VIS_REFLECTION_MEASURE,
    STATE_VIS_TRANSMISSION_DISPLAY,
    STATE_VIS_TRANSMISSION_MEASURE,
    STATE_UV_TRANSMISSION_DISPLAY,
    STATE_UV_TRANSMISSION_MEASURE,
    STATE_MAIN_MENU,
